...
const Navbar = () => {
  return (
    ...
    className='w-full sticky top-0 bg-white z-10'>
        ...
        <div
        className='w-full max-w-[1360px] mx-auto flex items-center justify-between py-4'>
            ...
            className='flex items-center gap-8'>
                ...
                className='px-2 py-2 leading-none rounded-md bg-[#94A3B8] bg-opacity-20 text-sm font-medium transition text-[#1A202C] hover:text-white hover:bg-[#1A73E8] flex items-center gap-1'>
                    Log in
                </button>
